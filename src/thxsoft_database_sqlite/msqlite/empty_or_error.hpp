...
#include "thxsoft_database_sqlite/msqlite/concepts.hpp"
#include "thxsoft_database_sqlite/msqlite/error.hpp"

#include "thxsoft_database_sqlite/msqlite/pipes/detail/empty_or_error.hpp"
...
//Executes 'f' with an empty 'std::optional<std::error_code>' if 'exp' has
