...
private:
    ...
    const std::string _upsertString = R"(INSERT INTO gaia (index,source_id,ra,dec,glon,glat,ruwe,parallax,teff_gspphot,teff_source,logg_gspphot,mh_gspphot,ebpminrp_gspphot,phot_g_mean_mag,phot_bp_mean_mag,bp_rp,non_single_star,luminosity,radius) VALUES {} ON CONFLICT DO NOTHING;)";
};
